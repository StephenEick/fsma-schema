...
//    private lateinit var tenantIdentifierResolver: TenantIdentifierResolver
    ...
    private fun deleteAllData() {
        ...
        jdbcTemplate.execute("DELETE FROM cte_initial_pack_produce CASCADE;")
        ...
        jdbcTemplate.execute("ALTER SEQUENCE IF EXISTS busines_seq RESTART;")
        ...
        jdbcTemplate.execute("ALTER SEQUENCE IF EXISTS cte_init_pack_produce_seq RESTART;")
